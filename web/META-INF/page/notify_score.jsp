            ...
            <article class="timeline-entry">
                <div class="timeline-entry-inner">
                    ...
                    <div class="timeline-label">
                        <h2>${n.text} <a onclick="setCourse(${n.course_id},'${n.link}')" class="usepointer"><span class="label label-default ">${n.course_name}</span></a>  <small class="pull-right">${cf:formatTime(n.noti_date)}</small></h2>
                        <!--<p>${n.text}</p>-->
                    </div>
                </div>
            </article>
